...
import { getStatusClassName, getStatusLabel } from "../lib/run-status";
import type { Drill, RunState } from "../types";
...
export function DrillHeader({ drill, runState }: DrillHeaderProps) {
  return (
